...
df = pd.read_csv('ufo-data/cleaned_wiki_sightings.csv', dtype=str, low_memory=False)
...
filler_words = {'000', '100', '200', '39s', '39ve', 'about', 'across', 'after', 'all', 'las',
                '2010', '2011', '2012', '2013', '300', '4th', '500','you', 'yes', 'within', 'more', 'nearby',
                'always', 'amp', 'and', 'any', 'appear', 'appeared', 'are', 'who', 'where', '39t',
                'around', 'ave', 'away', 'back', 'before', 'but', 'can', 'wasn', 'until', 'non',
                'couldn', 'each', 'for', 'from', 'going', 'had', 'have', 'how', 'took', 'these', 'seeing',
                'into', 'just', 'like', 'looked', 'moved', 'near', 'new', 'not', 'thought', 'came',
                'note', 'noticed', 'observed', 'off', 'one', 'onto', 'our', 'could', 'said', 'him',
                'out', 'over', 'possibly', 'quot',' just', 'roughly', 'same', 'san', 'saw', 'some',
...
mapping.to_csv('ufo-data/event_keyword_mapping.csv', index=False, header=['eventid','KeywordID'])
print("Saved:")
